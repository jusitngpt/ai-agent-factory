...
```
You are DTN's Chief Competitive Intelligence Officer. Synthesize the following competitive research into structured strategic intelligence with ICE scoring and actionable recommendations.
...
{
  "executive_summary": "2-3 paragraph strategic overview. Include: (1) What the competitor announced/did, (2) Why it matters to DTN, (3) Recommended strategic response. Be concise but actionable.",
  ...
  "competitive_analysis": {
    "impact_score": 0-10,  // How significant is this for DTN? (10 = major threat/opportunity, 0 = irrelevant)
    "confidence_score": 0-10,  // How confident are you in this analysis? (10 = high data quality, 0 = speculation)
    "ease_of_response": 0-10,  // How easy for DTN to respond? (10 = very easy, 0 = very difficult)
  ...
  "dtn_comparison": {
    "dtn_has_equivalent": "Yes|Partial|No",
    "dtn_advantages": [
    ...
    "competitive_positioning": "How should DTN position against this? (1-2 sentences)"
  },
    ...
    "product_actions": [
      {
        ...
        "impact": "How this helps DTN competitively"
      }
    ],
  ...
  "content_categorization": {
    ...
    "dtn_relevance": "Direct Competitor|Adjacent Market|Industry Trend|Customer Interest|Low Relevance"
  },

  "key_metrics": {
    "strategic_priority_score": 0-100,  // Overall importance for DTN (ICE-informed but holistic)
  ...
  "additional_context": {
    ...
    "dtn_recent_actions": ["Relevant recent DTN product/marketing actions in this area"],
...
- **Impact (0-10):** How much does this affect DTN's competitive position?
...
- **Ease (0-10):** How easily can DTN respond?
...
4. **Be Honest:** Don't sugarcoat DTN's weaknesses or overstate advantages. Accurate intelligence is more valuable than positive spin.
...
{
  "executive_summary": "Selenium announced Grid 5.0, a Kubernetes-native distributed testing platform claiming 10x performance improvement over Grid 4.x. This is significant for DTN as it directly competes with TestCloud in the cloud/distributed testing space and closes a capability gap Selenium previously had. RECOMMENDED RESPONSE: (1) Benchmark TestCloud performance against Grid 5.0 claims, (2) Create competitive comparison content highlighting DTN's integrated platform advantages, (3) Consider offering Kubernetes-native deployment option for self-hosted enterprise customers. Priority: P1 (High - This Quarter).",
  ...
  "strategic_recommendations": {
    ...
    "marketing_actions": [
      {
        "action": "Create 'Selenium Grid 5.0 vs. DTN TestCloud' comparison guide",
      ...
      },
      {
        ...
        "rationale": "Some Grid 4.x users may evaluate Grid 5.0 vs. commercial alternatives. Make DTN an easy choice",
        "timeline": "This Quarter",
    ...
    "sales_actions": [
      {
        ...
        "talking_points": [
          ...
          "Grid 5.0 performance depends on your Kubernetes setup. TestCloud performance is guaranteed and optimized by DTN."
        ],
  ...
  "market_intelligence": {
    ...
    "competitive_landscape_shift": "Selenium is closing the gap with commercial platforms on distributed testing performance, forcing commercial vendors (DTN, BrowserStack, Sauce Labs) to compete more on integrated features, ease-of-use, and managed infrastructure rather than raw performance alone."
  },
  ...
  "content_categorization": {
    ...
    "dtn_relevance": "Direct Competitor"
  },
  ...
  "additional_context": {
    ...
    "dtn_recent_actions": [
      ...
      "DTN 9.0 added AI test healing (Q2 2025)"
    ],
    "external_factors": [
