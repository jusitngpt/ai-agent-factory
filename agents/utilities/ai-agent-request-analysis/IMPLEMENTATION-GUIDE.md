...
4. Add scopes:
   ...
   - `data.records:write`
   - `schema.bases:read`
5. Add access to your "AI Agent Factory" base
...
2. Set description: `"AI agent request analysis notifications from the system"`
...
2. Type: `/invite @AI Agent Factory`
...
4. Consider implementing other agents from the factory
...
**Questions?** See TROUBLESHOOTING.md or contact your system administrator.
