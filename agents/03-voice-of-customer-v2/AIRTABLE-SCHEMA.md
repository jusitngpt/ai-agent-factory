...
| 11 | Strengths vs DTN (JSON) | Long text | Competitive advantages |
| 12 | Weaknesses vs DTN (JSON) | Long text | Competitive vulnerabilities |
...
- **Filter:** Weaknesses vs DTN (JSON) is not empty
- **Sort:** Strategic Priority Score (desc)
...
### 3. Trend Alert
- **Trigger:** Rating Trend = "Declining" for DTN (if tracking DTN)
