...
3. Name it: **"DTN Agent Factory"** (or your preferred name)
...
1. Click the node
2. Update **"Credential to connect with"**: Select "Airtable DTN AF Access"
3. Update **"Base"**:
   - Click dropdown
...
1. Click the node
2. Update **"Credential to connect with"**: Select "Slack DTN AF Bot"
3. Update **"Channel"**:
