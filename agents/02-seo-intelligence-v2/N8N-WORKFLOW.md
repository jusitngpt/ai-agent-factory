...
**Prompt Template:**
```
You are DTN's SEO Strategy Director. Analyze the following SEO competitive intelligence and provide strategic insights and recommendations.
...
**Your Task:**
Synthesize this research into actionable SEO intelligence for DTN's content and marketing teams.
...

{
  ...
  "competitive_advantages_dtn_can_exploit": [
    {
      "advantage": "Area where competitor is weak or absent",
      "opportunity": "How DTN can capitalize",
...
```json
{
  ...
  "DTN Advantages (JSON)": "={{JSON.stringify($json.competitive_advantages_dtn_can_exploit, null, 2)}}",
...
4. Contact: DTN Marketing Automation Team
