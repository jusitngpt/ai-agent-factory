...
5. COMPETITIVE MENTIONS
   - How often is your product mentioned in their reviews?
...
{
  "executive_summary": "2-3 paragraphs: overall sentiment, key findings, strategic implications for your product",
  ...
  "positive_themes": [
    {
      ...
      "strategic_implication": "What this means for your product (1-2 sentences)"
    }
  ],
  ...
  "negative_themes": [
    {
      ...
      "strategic_implication": "Opportunity for your product (1-2 sentences)"
    }
  ],
...
```json
{
  ...
  "Strengths vs your product (JSON)": "={{JSON.stringify($json.competitive_insights.strengths_vs_katalon, null, 2)}}",
  "Weaknesses vs your product (JSON)": "={{JSON.stringify($json.competitive_insights.weaknesses_vs_katalon, null, 2)}}",
