...
3. Name your base: **"DTN Agent Factory"** (or your company name)
...
| 17 | DTN Advantages (JSON) | Long text | - |
...
5. Scopes:
   ...
   - ✅ `data.records:write`
   - ✅ `schema.bases:read`
6. Access: Select your "DTN Agent Factory" base
...
1. Click node to open settings
2. Under "Credentials", select your **Airtable - DTN AF** credential
