...
```json
{
  "parameters": {
    ...
    "options": {
      "systemMessage": "=You are a competitive intelligence analyst for the AI Agent Factory system. Your role is to analyze competitor blog posts and RSS feed items to extract strategic insights, competitive intelligence, and actionable recommendations. [Full system prompt - see detailed version in README.md]"
    }
  }
}
```
...
```
You are a competitive intelligence analyst for the AI Agent Factory system.
...
```json
{
  "parameters": {
    ...
    "base": {
      ...
      "mode": "list",
      "cachedResultName": "AI Agent Factory",
